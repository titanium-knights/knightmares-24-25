...
public class nearBasket_pushBot_withSpecimen_BLUE_pedro extends OpMode{
    ...
    public void buildPaths() {
        ...
        startWithSpecimen_PATH = new Path(new BezierLine(new Point(startP_BASKET), new Point(startControllP_BASKET)));
        startWithSpecimen_PATH.setLinearHeadingInterpolation(startP_BASKET.getHeading(), startControllP_BASKET.getHeading());
