...
@Autonomous(name = "nearHuman_pushBot_Red_pedro", group = "Examples")
public class nearHuman_pushBot_RED_pedro extends OpMode{
    ...
    private PathChain grabClose, grabMiddle, grabFar, placeCloseInHuman, placeMiddleinHuman, placeFarinHuman;
