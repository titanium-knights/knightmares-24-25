...
@Autonomous(name = "backwardsTry", group = "Examples")
public class backwardsTry extends OpMode{
...
//    public ClawRotator clawRot;
    ...
    private final Pose turn = new Pose(20, 58, Math.toRadians(240));
    private final Pose turn2 = new Pose(30, 58, Math.toRadians(240));
