...
public class nearHuman_pushBot_NoSpecimen_pedro extends OpMode{
    ...
    private final Pose pickupCloseP_HUMAN = new Pose(56, 32, Math.toRadians(270));
    ...
    private final Pose startControllP_HUMAN = new Pose(10, 32, Math.toRadians(0));
    private final Pose controllBeforeCloseP_HUMAN = new Pose(50, 32, Math.toRadians(0));
