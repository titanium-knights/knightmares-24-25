...
//
//import static org.firstinspires.ftc.teamcode.ThreeDeadWheelLocalizer.PARAMS;
//
...
//import org.firstinspires.ftc.teamcode.SimpleMecanumDrive;
...
//    public static final Class<?> DRIVE_CLASS = SimpleMecanumDrive.class;
//
...
//        if (DRIVE_CLASS.equals(SimpleMecanumDrive.class)) {
//            dvf = hardwareMap -> {
//                SimpleMecanumDrive md = new SimpleMecanumDrive(hardwareMap, new SparkFunOTOS.Pose2D(0, 0, 0));
//
//                List<Encoder> leftEncs = new ArrayList<>(), rightEncs = new ArrayList<>();
//                List<Encoder> parEncs = new ArrayList<>(), perpEncs = new ArrayList<>();
//                if (md.localizer instanceof SimpleMecanumDrive.DriveLocalizer) {
//                    SimpleMecanumDrive.DriveLocalizer dl = (SimpleMecanumDrive.DriveLocalizer) md.localizer;
...
//                    DriveType.MECANUM,
//                        SimpleMecanumDrive.PARAMS.inPerTick,
//                        SimpleMecanumDrive.PARAMS.maxWheelVel,
//                        SimpleMecanumDrive.PARAMS.minProfileAccel,
//                        SimpleMecanumDrive.PARAMS.maxProfileAccel,
...
//                        md.lazyImu,
//                        md.voltageSensor,
//                        () -> new MotorFeedforward(SimpleMecanumDrive.PARAMS.kS,
//                                SimpleMecanumDrive.PARAMS.kV / SimpleMecanumDrive.PARAMS.inPerTick,
//                                SimpleMecanumDrive.PARAMS.kA / SimpleMecanumDrive.PARAMS.inPerTick)
//                );
//            };
